...
export default function EditBook() {
  ...
  const {
    ...
    defaultValues: {
      name: edit_book?.Name || "",
      description: edit_book?.Description || "",
      category_id: edit_book?.category_id || null,
      image: edit_book?.Image || null,
    },
  });
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.EXPO_PUBLIC_API_URL}/books/${edit_book?.id}/edit`,
        {
          method: "PATCH",
          headers: {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      >
        <Text style={styles.submitButtonText}>Edit Book</Text>
      </TouchableOpacity>
    </ScrollView>
  );
}
